      ...
      <div className="px-4 py-4 space-y-5 pb-8">
          ...
          <div className="grid grid-cols-2 gap-2">
            {GROUP_OPTIONS.map(g => (
              <button
                key={g.value}
                type="button"
                onClick={() => setAnimalGroup(g.value)}
                className={clsx(
              ...
              >
                <p>{g.label}</p>
                <p className={clsx('text-[10px] mt-0.5', animalGroup === g.value ? 'text-primary-200' : 'text-gray-400')}>
                  {g.hint}
                </p>
              </button>
            ))}
        ...
        <div className="grid grid-cols-3 gap-3">
          {animalGroup === 'lactating' && (
            <div>
              ...
              <div className="relative">
                <input
                  type="number" min="0" max="60" step="1" inputMode="decimal"
                  value={milkYield}
          ...
          <div>
            ...
            <div className="relative">
              <input
                type="number" min="50" max="900" step="10"
                value={liveWeight}
        ...
        {ration && (
          <div className="space-y-3">
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              <Input
                label="Plan Name"
                placeholder="e.g. Lactating Cows — High Yield"
                required
                value={data.name}
