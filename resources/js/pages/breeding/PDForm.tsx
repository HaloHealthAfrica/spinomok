    ...
    <AppLayout title="Pregnancy Check" showBottomNav={false}>
      ...
      <form onSubmit={submit} noValidate>
        <div className="px-4 py-4 space-y-5">
          ...
          {/* Manual animal selection if no pending services */}
          {pendingServices.length === 0 && (
            <div>
          ...
          {/* Check date */}
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-1">Date of PD Check <span className="text-red-500">*</span></label>
            <input
              type="date"
          ...
          {/* Result */}
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Result <span className="text-red-500">*</span></label>
              ...
              {RESULTS.map(r => (
                <button
                  ...
                  className={clsx(
                    ...
                    data.result === r.value ? r.color + ' ring-2 ring-offset-1 ring-primary-600' : 'bg-white text-gray-600 border-gray-300',
                  )}
                >
                  {r.label}
                </button>
